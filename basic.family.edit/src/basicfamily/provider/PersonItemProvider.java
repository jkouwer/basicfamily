...
/**
 * This is the item provider adapter for a {@link basicfamily.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BasicfamilyPackage.Literals.PERSON__BIRTH_DATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRelationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_relations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_relations_feature", "_UI_Person_type"),
				 BasicfamilyPackage.Literals.PERSON__RELATIONS,
				 true,
				 false,
				 true,
				 null,
